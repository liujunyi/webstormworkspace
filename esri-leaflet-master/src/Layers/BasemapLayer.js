(function(EsriLeaflet){
  ...
  EsriLeaflet.Layers.BasemapLayer = L.TileLayer.extend({
    statics: {
      TILES: {
          Geoq: {
              urlTemplate: tileProtocol + '//{s}.map.geoq.cn/ArcGIS/rest/services/ChinaOnlineCommunity/MapServer/tile/{z}/{y}/{x}',
              attributionUrl: 'http://map.geoq.cn/ArcGIS/rest/services/ChinaOnlineCommunity/MapServer',
              options: {
                  hideLogo: false,
