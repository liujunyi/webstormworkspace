define([
...
], function (declare, arrayUtils, Color, connect, SpatialReference, Point, Graphic, SimpleMarkerSymbol, TextSymbol, PopupTemplate, GraphicsLayer) {
    return declare([GraphicsLayer], {
        ...
        _clusterTest: function (p, cluster) {
            if (p.attributes.Test === cluster.field) {
//                console.log("true");
                var distance = (
                    Math.sqrt(
